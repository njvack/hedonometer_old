...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduledSample.sent_at'
        db.add_column('texter_scheduledsample', 'sent_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ScheduledSample.answered_at'
        db.add_column('texter_scheduledsample', 'answered_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScheduledSample.sent_at'
        db.delete_column('texter_scheduledsample', 'sent_at')

        # Deleting field 'ScheduledSample.answered_at'
        db.delete_column('texter_scheduledsample', 'answered_at')
    ...
    models = {
        ...
        'texter.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'mphfzmfmkf'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
