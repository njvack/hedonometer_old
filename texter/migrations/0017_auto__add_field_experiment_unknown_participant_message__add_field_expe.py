...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.unknown_participant_message'
        db.add_column('texter_experiment', 'unknown_participant_message', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Experiment.no_response_needed_message'
        db.add_column('texter_experiment', 'no_response_needed_message', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Experiment.bad_answer_message'
        db.add_column('texter_experiment', 'bad_answer_message', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.unknown_participant_message'
        db.delete_column('texter_experiment', 'unknown_participant_message')

        # Deleting field 'Experiment.no_response_needed_message'
        db.delete_column('texter_experiment', 'no_response_needed_message')

        # Deleting field 'Experiment.bad_answer_message'
        db.delete_column('texter_experiment', 'bad_answer_message')
    ...
    models = {
        ...
        'texter.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'bbgfkqrqph'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
