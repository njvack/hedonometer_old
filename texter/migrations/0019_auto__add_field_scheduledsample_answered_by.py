...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduledSample.answered_by'
        db.add_column('texter_scheduledsample', 'answered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['texter.IncomingTextMessage'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScheduledSample.answered_by'
        db.delete_column('texter_scheduledsample', 'answered_by_id')
    ...
    models = {
        ...
        'texter.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'cjsmhbvsdn'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
        ...
        'texter.scheduledsample': {
            ...
            'answered_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['texter.IncomingTextMessage']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
