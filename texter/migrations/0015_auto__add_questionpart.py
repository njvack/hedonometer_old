...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('texter_questionpart', (
        ...
        db.send_create_signal('texter', ['QuestionPart'])


    def backwards(self, orm):
        
        # Deleting model 'QuestionPart'
        db.delete_table('texter_questionpart')
    ...
    models = {
        ...
        'texter.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'mhcfkctcbt'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
