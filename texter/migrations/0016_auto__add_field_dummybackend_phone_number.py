...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DummyBackend.phone_number'
        db.add_column('texter_dummybackend', 'phone_number', self.gf('texter.models.PhoneNumberField')(default=1, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DummyBackend.phone_number'
        db.delete_column('texter_dummybackend', 'phone_number')
    ...
    models = {
        ...
        'texter.experiment': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'url_slug': ('django.db.models.fields.SlugField', [], {'default': "'shvsnsgkqm'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'})
        },
